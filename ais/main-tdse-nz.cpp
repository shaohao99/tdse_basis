...
// =========== time propagation ===============
  ...
  for(int i=0; i<nt; i++){  
    ...
    DME_array_time_AIS1(EXt, ELt, nE, i1, i2, j2, j3, j4, j5, j6, j7, i3, i4, i5, i6, ai1j2, ai1j3, ai1j5, ai1j7, ai2j4, ai2j6, ai3j4, ai4j5, ai5j6, ai6j7, Ham);  // update values and nonzero structure of H_temp in time
    //MatSetOption(Ham,MAT_HERMITIAN,PETSC_TRUE);  // before assembly begin, set Hermitian
